...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Feedback', path: '/feedbacks', entity: 'feedback', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Strategy', path: '/strategies', entity: 'strategy', service: AccessServiceEnum.PROJECT, icon: FiBox },
